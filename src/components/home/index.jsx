      ...
      <section class="text-gray-600">
        <div class="container mx-auto flex px-5 py-20 md:flex-row flex-col items-center">
          <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
            <h1 class="sm:text-6xl text-4xl mb-4 font-medium text-gray-900">Connect with your
              <br class="hidden lg:inline-block" /> friends
            </h1>
            <p class="mb-8 leading-relaxed">Lorem ipsum dolor sit amet consectetur adipisicing elit. Mollitia sunt similique magnam quo quae nesciunt dolor, optio culpa dolore amet </p>
          ...
          <div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
            <img class="object-cover object-center rounded" alt="hero" src="./public/phone.png" />
          </div>
        </div>
      </section>
  }
